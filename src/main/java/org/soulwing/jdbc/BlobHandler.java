...
/**
 * An API user callback that prepares a {@link Blob} before a JDBC insert or
 * update operation.
 *
 * @author Carl Harris
 */
public interface BlobHandler {
  ...
  /**
   * Prepares the given {@link Blob} before it is included an in insert or
   * update statement.
   * <p>
   * An implementation will typically provide the content for the large object.
   * @param blob the large object to prepare
