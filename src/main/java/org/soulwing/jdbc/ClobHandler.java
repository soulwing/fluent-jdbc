...
/**
 * An API user callback that prepares a {@link Clob} before a JDBC insert or
 * update operation.
 *
 * @author Carl Harris
 */
public interface ClobHandler {
  ...
  /**
   * Prepares the given {@link Clob} before it is included an in insert or
   * update statement.
   * <p>
   * An implementation will typically provide the content for the large object.
   * @param clob the large object to prepare
