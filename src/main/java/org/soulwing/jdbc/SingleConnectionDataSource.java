...
/**
 * A {@link DataSource} that has a single shared connection.
 * <p/>
 * Care should be taken that this data source is not shared by multiple threads,
 * since transaction state is usually managed by having a connection per
 * thread.
 * @author Carl Harris
 */
