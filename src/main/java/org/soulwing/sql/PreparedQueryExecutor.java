...
/**
 * An {@link SQLExecutor} that executes a prepared query.
 *
 * @author Carl Harris
 */
class PreparedQueryExecutor extends AbstractPreparedStatementExecutor<ResultSet> {

  public PreparedQueryExecutor(PreparedStatementCreator psc,
